...
if(WINDOWS AND NOT UNIX)
    set(LUA_LDIR "!\\delua\\" CACHE STRING "Lua module directory.")
    set(LUA_CDIR "!\\" CACHE STRING "Lua dynamic library (C) directory.")
else()
    set(LUA_LDIR "LUA_ROOT \"share/delua/\" LUA_VDIR \"/\"" CACHE STRING "Lua module directory.")
    set(LUA_CDIR "LUA_ROOT \"lib/delua/\" LUA_VDIR \"/\"" CACHE STRING "Lua dynamic library (C) directory.")
endif()
