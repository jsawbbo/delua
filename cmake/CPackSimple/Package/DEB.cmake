	...
	if(UNIX AND NOT APPLE)
		...
		if(DISTRIBUTION MATCHES ${__deb_DISTRIBUTION})
	        ...
	        foreach(component ${CPACK_COMPONENTS_ALL})
	            ...
	            if(DEFINED CPACK_SIMPLE_COMPONENT_${component}_PACKAGE_SUFFIX)
		            if(NOT ${CPACK_SIMPLE_COMPONENT_${component}_PACKAGE_SUFFIX} STREQUAL OFF)
		                set(SUFFIX "-${CPACK_SIMPLE_COMPONENT_${component}_PACKAGE_SUFFIX}")
	                else()
		                set(SUFFIX "")
	                endif()
	            else()
	            ...
	            if(NOT DEFINED __deb_TEMPLATE)
			        ...
			        string(CONFIGURE "${__deb_TEMPLATE}${SUFFIX}.deb" CPACK_DEBIAN_${COMPONENT}_FILE_NAME @ONLY)
